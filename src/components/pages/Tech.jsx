...
import PyLogo from "../../assets/img/experience/icons8-python-240.png";
import DockerLogo from "../../assets/img/experience/icons8-docker-240.png";
        ...
        <div className="skills-container">
          <div className="icon">
            <a href="https://bit.ly/3q0aR0t">
              <img src={NodeLogo} alt="NodeJS" className="icon-card" />
            </a>
          </div>

          <div className="icon">
            <a href="https://mzl.la/3k0nK74">
              <img src={JsLogo} alt="JS" className="icon-card" />
            </a>
          </div>

          <div className="icon">
            <a href="https://www.python.org/">
              <img src={PyLogo} alt="Python" className="icon-card" />
            </a>
          </div>

          <div className="icon">
            <a href="https://www.docker.com/">
              <img src={DockerLogo} alt="Docker" className="icon-card" />
            </a>
          </div>

          <div className="icon">
            <a href="https://bit.ly/3LvE0Jl">
              <img src={GitLogo} alt="Git" className="icon-card" />
            </a>
          </div>

          <div className="icon">
            <a href="https://bit.ly/3BFg1RU">
              <img src={ReactLogo} alt="ReactJS" className="icon-card" />
            </a>
          </div>

          <div className="icon">
            <a href="https://mzl.la/3mD6SFd">
              <img src={HtmlLogo} alt="HTML" className="icon-card" />
            </a>
          </div>
          <div className="icon">
            <a href="https://mzl.la/3pZdoIl">
              <img src={CssLogo} alt="CSS" className="icon-card" />
            </a>
          </div>
        </div>
      </section>
